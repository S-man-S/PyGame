...
IFontDisp = Font
__all__ = [ 'Color', 'Default', 'OLE_XSIZE_PIXELS',
           'OLE_OPTEXCLUSIVE', 'IPicture', 'OLE_TRISTATE',
           'OLE_YSIZE_PIXELS', 'VgaColor', 'OLE_XSIZE_CONTAINER',
           'FONTBOLD', 'FONTUNDERSCORE', 'OLE_ENABLEDEFAULTBOOL',
           'IFontDisp', 'IFont', 'OLE_YSIZE_HIMETRIC',
           'OLE_YPOS_HIMETRIC', 'FONTITALIC', 'OLE_XSIZE_HIMETRIC',
           'Picture', 'IFontEventsDisp', 'OLE_YSIZE_CONTAINER',
           'OLE_HANDLE', 'Font', 'OLE_XPOS_CONTAINER', 'Monochrome',
           'Checked', 'OLE_YPOS_PIXELS', 'Gray', 'OLE_COLOR',
           'OLE_CANCELBOOL', 'LoadPictureConstants', 'FONTNAME',
           'OLE_YPOS_CONTAINER', 'StdFont', 'OLE_XPOS_PIXELS',
           'FontEvents', 'IPictureDisp', 'StdPicture', 'FONTSIZE',
           'FONTSTRIKETHROUGH', 'Unchecked', 'OLE_XPOS_HIMETRIC']
